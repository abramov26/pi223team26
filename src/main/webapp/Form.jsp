    ...
    <div class="interactive__area">
        ...
        <form action="${pageContext.request.contextPath}/JavaCalc" method="POST">
            <div class="main__form">
                <input class="ball__radius__input" type="number" name="first" placeholder="Радиус шара (м)">
                <input class="height__input" type="number" name="second" placeholder="Высота (м)">
